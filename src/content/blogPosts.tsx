    ...
    content: (
      <>
        ...
        <p className="lowercase">
          ...
          <img
            src="/emojis/heavysob.png"
            alt="heavysob"
            className="inline-block h-5 w-5 align-text-bottom"
            loading="lazy"
          />
          ) and saw a video about sleep paralysis. i hadnt known what it was about prior to this one video. i did a lil research on it and it seemed pretty cool to me...
        </p>

        <p className="lowercase">until i had my own sleep paralysis experience.</p>

        <p className="lowercase">that was not fun.</p>

        <p className="font-bold normal-case">
          AT ALL{" "}
          <img
            src="/emojis/3kcursed.png"
            alt="3kcursed"
            className="inline-block h-5 w-5 align-text-bottom"
            loading="lazy"
          />
        ...
        <p className="lowercase">
          this game is called "CAN'T WAKE UP". yes, in all caps so i make it seem super scary
          <img
            src="/emojis/shocked.png"
            alt="shocked"
            className="inline-block h-5 w-5 align-text-bottom"
            loading="lazy"
          />
          . i might refer to it as "cwu" from here on out just because its less effort to type out and also cuz im lazy. after this sleep paralysis episode of mine, i suddenly just had an idea. to make a game out of it.
        </p>
        ...
        <ul className="list-disc pl-6 lowercase text-foreground/90">
          <li>
            the pizza in the fridge being green for some reason{" "}
            <img
              src="/emojis/3kcursed.png"
              alt="3kcursed"
              className="inline-block h-5 w-5 align-text-bottom"
          ...
          <li>
            bloody hand prints on the mirror after shower{" "}
            <img
              src="/emojis/3kcursed.png"
              alt="3kcursed"
              className="inline-block h-5 w-5 align-text-bottom"
          ...
          <li>
            tv playing weird stuff/distortion{" "}
            <img
              src="/emojis/3kcursed.png"
              alt="3kcursed"
              className="inline-block h-5 w-5 align-text-bottom"
          ...
          <li>
            when folding clothes, one shirt is covered in blood/has a bloody handprint on it{" "}
            <img
              src="/emojis/3kcursed.png"
              alt="3kcursed"
              className="inline-block h-5 w-5 align-text-bottom"
          ...
          <li>
            doing a task but it actually "undoes" itself so you have to do it again{" "}
            <img
              src="/emojis/3kcursed.png"
              alt="3kcursed"
              className="inline-block h-5 w-5 align-text-bottom"
